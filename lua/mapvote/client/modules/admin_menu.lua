...
local configMenuOptions = {
    ...
    { "The maximum amount of disk space left before ending nomination commands (in bytes, default = 20 GB)", schema.fields.NominateByteThreshold,       "NominateByteThreshold" },
}
